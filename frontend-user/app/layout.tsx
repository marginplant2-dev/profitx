...
export const metadata: Metadata = {
  title: {
    default: "ProfitX — Indian Trading Platform",
    template: "%s · ProfitX",
  },
  description:
    "Trade Indian stocks, F&O, commodities, currencies, and crypto with ProfitX — fast, transparent, dark-themed.",
  icons: {
    icon: "/profitx-mark.svg",
    shortcut: "/profitx-mark.svg",
    apple: "/profitx-mark.svg",
  },
  // PWA — Apple-specific bits (Android/Chrome pick these up from
  // /manifest.webmanifest auto-generated by app/manifest.ts).
  applicationName: "ProfitX",
  appleWebApp: {
    capable: true,
    title: "ProfitX",
