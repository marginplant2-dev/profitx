...
export const metadata: Metadata = {
  title: "Features",
  description:
    "The pro terminal, mobile app, risk engine, ledger and contract-note system that power ProfitX. Every feature, in detail.",
};
...
const PLATFORM = [
  ...
  { title: "99.97% uptime over 6 months",    body: "Public status page at status.profitx.info. Every incident has a public post-mortem." },
