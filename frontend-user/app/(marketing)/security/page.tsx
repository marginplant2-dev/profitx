...
export const metadata: Metadata = {
  ...
  description:
    "How ProfitX protects your money, your data and your trading account — and the regulatory framework we operate under.",
};
...
const RESPONSIBLE_DISCLOSURE = [
  "Email security@profitx.info with a clear write-up and steps to reproduce.",
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 lg:px-8">
        <div className="grid items-start gap-12 lg:grid-cols-2">
          <div>
            ...
            <Link href="mailto:security@profitx.info" className="mt-5 inline-flex h-11 items-center gap-2 rounded-full bg-primary px-6 text-sm font-semibold text-primary-foreground shadow-lg shadow-primary/25 hover:bg-primary/90">
              security@profitx.info <ArrowRight className="size-4" />
            </Link>
          </div>
