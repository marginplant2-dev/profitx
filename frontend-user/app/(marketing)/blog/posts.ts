...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    seoTitle: "How to open a Demat account in India | ProfitX",
    seoDescription:
    ...
    body: [
      "A Demat account holds your shares and securities in electronic form, while a trading account is what you use to place buy and sell orders on the exchanges. To invest in Indian markets you need both, and with ProfitX they come together in a single online application.",
  ...
  },
  {
    ...
    seoTitle: "Equity delivery vs intraday explained | ProfitX",
    seoDescription:
    ...
    body: [
      ...
      "The two are also priced differently. On ProfitX, equity delivery is free, while intraday is charged at a low flat per-order rate. Pick delivery when you're investing in a business you believe in, and intraday only when you have a clear, disciplined short-term plan and a stop-loss in place.",
    ],
    riskWarning: RISK_WARNING,
  },
  {
    ...
    seoTitle: "SPAN + Exposure margins explained | ProfitX",
    seoDescription:
    ...
    body: [
      ...
      "Because these are exchange-mandated numbers, ProfitX shows them transparently before you place an order — there's no opaque markup. Always check the total margin and keep spare funds in your account, so a normal swing in the underlying doesn't trigger a margin shortfall or an auto square-off.",
    ],
    riskWarning: RISK_WARNING,
  },
];
