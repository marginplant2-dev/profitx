...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    seoTitle: "How to open a Demat account in India | MarginPlant",
    seoDescription:
    ...
    body: [
      "A Demat account holds your shares and securities in electronic form, while a trading account is what you use to place buy and sell orders on the exchanges. To invest in Indian markets you need both, and with MarginPlant they come together in a single online application.",
  ...
  },
  {
    ...
    seoTitle: "Equity delivery vs intraday explained | MarginPlant",
    seoDescription:
  ...
  },
  {
    ...
    seoTitle: "SPAN + Exposure margins explained | MarginPlant",
    seoDescription:
